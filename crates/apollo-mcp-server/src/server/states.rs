    ...
    pub(crate) async fn start(self, server: Server) -> Result<(), ServerError> {
        ...
        let mut state = State::Configuring(Configuring {
            config: Config {
                ...
                execute_tool_description: server.execute_tool_description,
                introspect_tool_description: server.introspect_tool_description,
                search_tool_description: server.search_tool_description,
                validate_tool_description: server.validate_tool_description,
