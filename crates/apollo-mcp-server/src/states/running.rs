...
use crate::{
    ...
    introspection::{EXECUTE_TOOL_NAME, Execute, INTROSPECT_TOOL_NAME, Introspect},
    operations::{MutationMode, Operation, RawOperation},
};

#[derive(Clone)]
pub(crate) struct Running {
    pub(crate) schema: Arc<Mutex<Valid<Schema>>>,
    pub(crate) operations: Arc<Mutex<Vec<Operation>>>,
    pub(crate) headers: HeaderMap,
    pub(crate) endpoint: String,
    pub(crate) execute_tool: Option<Execute>,
    pub(crate) introspect_tool: Option<Introspect>,
    pub(crate) explorer_tool: Option<Explorer>,
    pub(crate) custom_scalar_map: Option<CustomScalarMap>,
    pub(crate) peers: Arc<RwLock<Vec<Peer<RoleServer>>>>,
...
impl Running {
    ...
    pub(crate) async fn update_schema(self, schema: Valid<Schema>) -> Result<Running, ServerError> {
    ...
    pub(crate) async fn update_operations(
        self,
    ...
    pub(crate) async fn notify_tool_list_changed(peers: Arc<RwLock<Vec<Peer<RoleServer>>>>) {
