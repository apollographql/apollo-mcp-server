...
async fn main() -> anyhow::Result<()> {
    ...
    Ok(Server::builder()
        ...
        .maybe_execute_tool_description(config.introspection.execute.description)
        .maybe_introspect_tool_description(config.introspection.introspect.description)
        .maybe_search_tool_description(config.introspection.search.description)
        .maybe_validate_tool_description(config.introspection.validate.description)
