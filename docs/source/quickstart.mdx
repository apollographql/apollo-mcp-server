...
<Tab label="Container + SSE">

You can run an Apollo MCP Server in a container to communicate over SSE.

1. Pull in the official Apollo MCP Server container:
...
1. Start the container:
    ...
    docker run \
      -it --rm \
      -v <absolute-path-to-MCP-example-dir>:/data \
      -p 5000:5000
