...
| `-i, --introspection`                                 | Expose the schema to the MCP client through `introspect`, `search`, and `execute` tools. [Learn more](/apollo-mcp-server/guides/#introspection-tools).                                                                               |
