...
Deploying Apollo MCP Server this way requires Apollo GraphOS Operator v1.5.0 or later.
...
|-----------------------------------------------|------------------------------|-----------------------------------------------------------------------------------------------------------|
| Kubernetes environment                        | Apollo GraphOS Operator      | Manages the Deployment/Service/ConfigMap/Secret lifecycle for you                                         |
