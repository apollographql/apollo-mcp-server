...
2. Capture the live `tools/list` response after deployment. Store an approved, standardized snapshot using a consistent MCP protocol version and server configuration.
...
See the Tool-definition integrity limitations for the controls Apollo MCP Server doesn't provide automatically.
