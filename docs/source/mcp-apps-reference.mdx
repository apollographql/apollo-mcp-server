...
| `extraOutputs` | Additional free-form output data | No       | Extra outputs in manifest tool config | Object for writing free-form data to the manifest's tool config. Use for passing additional metadata that should be included in the tool's manifest entry.            |
...
| Element    | What it is                      | Where it maps to                     | Notes                                                                          |
| ---------- | ------------------------------- | ------------------------------------ | ------------------------------------------------------------------------------ |
| `@private` | Field visibility control marker | Field marked private in the manifest | Fields are excluded from the LLM-visible response but remain available in your app |
