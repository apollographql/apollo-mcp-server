...
The `@private` directive hides specified fields from the LLM while still making them accessible to your app's UI code. This prevents sensitive data from being exposed in AI responses.
