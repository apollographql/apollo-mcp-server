...
| -------------- | -------------------------------- | -------- | ------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `name`         | Tool name                        | No       | MCP tool `name`                 | Defaults to the GraphQL operation name if not provided. Must be unique within the app.                                                                                      |
| `description`  | Tool description                 | No       | MCP tool `description`          | Defaults to the GraphQL operation description if not provided. App description is prefixed to tool description if present.                                                  |
