...
Rhai scripts run as trusted server-side code. Restrict and review script changes, especially when using environment variables or outbound HTTP. For details, see the [Rhai security guidance](/apollo-mcp-server/rhai-getting-started#security).
