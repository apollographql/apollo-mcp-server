...
| `server/discover`  | Protocol version and capability discovery            |
| `tools/list`       | List available MCP tools                             |
| `resources/list`   | List available MCP resources                         |

<Note>

`server/discover` precedes `initialize` in the MCP 2026-07-28 lifecycle, so clients call it before they have any opportunity to authenticate.
