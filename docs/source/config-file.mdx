...
Some transport types support further configuration. For `streamable_http`, you can set the `address`, `port`, and `stateful_mode`.
...
| Option        | Type     | Default                                                  | Description                                  |
| :------------ | :------- | :------------------------------------------------------- | :------------------------------------------- |
| `name`        | `string` | `"Apollo MCP Server"`                                    | The name of the MCP server implementation    |
| `version`     | `string` | Current crate version (e.g., `"1.5.0"`)                  | The version of the MCP server implementation |
| `title`       | `string` | `"Apollo MCP Server"`                                    | Human-readable title for the server          |
