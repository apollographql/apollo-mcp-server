...
| `allow_headers`     | `List<string>` | `["content-type", "mcp-protocol-version", "mcp-session-id", "traceparent", "tracestate", "baggage"]` | List of allowed request headers, including MCP, W3C Trace Context, and W3C Baggage headers                   |
