...
For services like New Relic, use `delta` temporality and pass your API key via metadata:
...
```sh
export APOLLO_MCP_TELEMETRY__EXPORTERS__METRICS__OTLP__METADATA__API_KEY="${NEW_RELIC_API_KEY}"
```
