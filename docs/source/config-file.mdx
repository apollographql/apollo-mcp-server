...
| `execute.description`       | `string` |            | Append custom instructions to the `execute` tool description          |
...
| `introspect.description`    | `string` |            | Append custom instructions to the `introspect` tool description       |
...
| `search.description`        | `string` |            | Append custom instructions to the `search` tool description           |
| `validate`                  | `object` |            | Validation tool configuration                                         |
| `validate.enabled`          | `bool`   | `false`    | Enable validation tool                                                |
| `validate.description`      | `string` |            | Append custom instructions to the `validate` tool description         |
