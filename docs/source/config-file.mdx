...
| `disable_auth_token_passthrough`  | `bool`                | `false`       | Disable automatic propagation of the validated Authorization header to the downstream API. This doesn't override `forward_headers`.                                                                             |
