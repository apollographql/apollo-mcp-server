...
- **🎨 Build Custom ChatGPT Experiences**. With MCP Apps support, you can create custom, interactive experiences directly inside ChatGPT. Control how your data appears with custom HTML/UI resources, enabling rich visualizations, interactive forms, and branded experiences powered by your GraphQL APIs.
...
Want to build custom ChatGPT experiences? Check out the [MCP Apps quickstart](/apollo-mcp-server/apps-sdk-quickstart) to create your first interactive ChatGPT app.
