...
- **🔒 Govern AI access**. By adopting predefined persisted queries and restricting who can update operation sources, developers can govern what data and operations AI clients can access. The GraphQL API continues to enforce its authentication, authorization, and data-access policies.
